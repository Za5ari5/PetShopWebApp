...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	List<Product> products = pd.getLastProducts();
       ...
       <div class="center_content">
       	<div class="left_content">
        	...
        	<div class="feat_prod_box">
            	...
            	<div class="prod_img"><a href="details.jsp"><img style="width:100px;" src="images/<%=p.getImage() %>" alt="" title="" border="0" /></a></div>
                ...
                <div class="prod_det_box">
                    ...
                    <a href="/PetShopWebApp/Category" class="more">- more details -</a>
                    <div class="clear"></div>
                    </div>
